...
// studio-react_shop/node_modules/@sanity/vision/lib/_chunks-es/index.mjs
...
var visionUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources-LBGYP544.js")
});
var visionTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      component: (0, import_react.lazy)(() => import("./SanityVision-T33TDFMY.js")),
      options: config,
      router: route.create("/*"),
...
//# sourceMappingURL=chunk-4E45RREZ.js.map
